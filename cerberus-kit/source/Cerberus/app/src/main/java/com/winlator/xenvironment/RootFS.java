...
public class RootFS {
    ...
    /** Separate Bionic root. Classic GLIBC remains untouched. */
    public static RootFS findBionic(Context context) {
        return new RootFS(new File(context.getFilesDir(), "cerberus-bionic/rootfs"));
    }
    ...
    public int getVersion() {
        ...
        try {
            java.util.List<String> lines = FileUtils.readLines(rfsVersionFile);
